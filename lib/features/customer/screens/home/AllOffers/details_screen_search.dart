...
import '../../../widgets/add_to_cart_from_search.dart';
import '../../../widgets/product_description.dart';

class DetailsScreenProductSearch extends StatefulWidget {
  const DetailsScreenProductSearch(
  ...
  @override
  State<DetailsScreenProductSearch> createState() =>
      _DetailsScreenProductState();
}

class _DetailsScreenProductState extends State<DetailsScreenProductSearch> {
  @override
  void initState() {
    super.initState();
      ...
      child: BlocBuilder<CustomerCubit, CustomerState>(
        builder: (context, state) {
          return Scaffold(
            ...
            bottomNavigationBar: AddTOCheckoutCardFromSearch(
              index: widget.index,
