...
class BodyAllProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return state.productsUser.isNotEmpty
        ? Padding(
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (_) => UpdateScreen(
                                              id: state.productsUser[index].id,
                                            ),
                                          ));
                                    },
                                    child: ClipRRect(
                                      ...
                                      child: FadeInImage.assetNetwork(
                                        ...
                                        image:
                                            state.productsUser[index].images[0],
                                        placeholder:
        ...
        : ScreenImpty(
            imagePath: AssetsManager.orderEmpty, text: "NO Product added ");
  }
}
